const shortcodes: Record<string, string> = {
  ...
  bug: "1F41B",
  bulb: "1F4A1",
  bulconsttrain_front: "1F685",
  bulconsttrain_side: "1F684",
  burrito: "1F32F",
  bus: "1F68C",
  busstop: "1F68F",
...
export function fromShortcode(shortcode: string): string | undefined {
  const u = shortcodes[shortcode];
  if (u) {
